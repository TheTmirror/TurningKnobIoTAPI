...
import static org.eclipse.smarthome.binding.drehbinding.internal.DrehbindingBindingConstants.CHANNEL_NUMBER;
...
public class DrehbindingHandler extends BaseThingHandler implements RESTIOParticipant {
    ...
    // public DrehBindingHandler(Thing thing, UpnpIOService service, UpnpService upnpService) {
    // super(thing);
    // this.service = service;
                ...
                case "class org.eclipse.smarthome.core.library.types.DecimalType":
                    ...
                    switch (value) {
                        ...
                        case 3:
                            ...
                            service.removeSubscription(this, topic);
                            break;
                    }
                    break;
            }
    ...
    public void initialize() {
        ...
        scheduler.execute(() -> {
            ...
            if (service.isDeviceOnlineAndReachable()) {
                ...
                service.addSubscription(this, "meinTopic");
            } else {
    ...
    @Override
    public void onSubcriptionEvent(String topic, @Nullable String values) {
        logger.debug("AN EVENT HAPPEND FOR ME!!!!!");
    }

    @Override
    public ThingUID getThingUID() {
        // TODO Auto-generated method stub
        return new ThingUID("TEST");
    }
}
